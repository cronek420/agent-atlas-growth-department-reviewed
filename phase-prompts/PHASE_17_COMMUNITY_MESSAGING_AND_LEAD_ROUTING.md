# Phase 17 — Community, Messaging, and Lead Routing

## Objective

Build safe comment/DM classification, approved FAQ responses, consent and opt-out handling, lead qualification, and escalation.

## Prerequisite

Phase 16 must have a PASS or approved CONDITIONAL PASS.
...
```text
You are the Phase 17 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Community, Messaging, and Lead Routing
...
14. Write agent_runs/phase-17/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 18.
...
- AI identity not misrepresented
...
- [ ] Current phase is recorded as `17`
