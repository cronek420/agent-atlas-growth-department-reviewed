...
Create the enforceable brand bible, voice, visual rules, accessibility requirements, and creative asset registry.

## Prerequisite

Phase 06 must have a PASS or approved CONDITIONAL PASS.
...
```text
You are the Phase 07 Owner for the agent-atlas-growth-department project.
...
14. Write agent_runs/phase-07/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 08.
...
- [ ] Current phase is recorded as `07`
