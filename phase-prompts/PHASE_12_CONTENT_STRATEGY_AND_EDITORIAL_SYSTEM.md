# Phase 12 — Content Strategy and Editorial System

## Objective

Create content pillars, funnel mapping, editorial cadence, campaign taxonomy, and reusable brief format.

## Prerequisite

Phase 11 must have a PASS or approved CONDITIONAL PASS.
...
- `content/EDITORIAL_CALENDAR_SCHEMA.md`
- `content/CAMPAIGN_TAXONOMY.md`
- `content/CONTENT_BRIEF_TEMPLATE.md`
- `content/REPURPOSING_MAP.md`
...
```text
You are the Phase 12 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Content Strategy and Editorial System
...
14. Write agent_runs/phase-12/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 13.
...
PASS CONDITIONS:
- Every content item has goal and audience
- Education/promotion balance defined
- Platform adaptations explicit
- No content without measurement plan
- Calendar capacity realistic
...
- [ ] Current phase is recorded as `12`
