...
Inspect, classify, install, or specify the smallest safe skill and connector set required for later phases.

## Prerequisite

Phase 01 must have a PASS or approved CONDITIONAL PASS.
...
- License and Provenance Reviewer
...
```text
You are the Phase 02 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Capability Registry and Skill Foundation
...
14. Write agent_runs/phase-02/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 03.
...
- [ ] Current phase is recorded as `02`
