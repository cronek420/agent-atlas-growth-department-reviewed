...
Create a validated product knowledge base for Rough Draft Builders Club without inventing missing facts.

## Prerequisite

Phase 05 must have a PASS or approved CONDITIONAL PASS.
...
- `product/COMPANY_PROFILE.md`
- `product/PRODUCT_PROFILE.md`
- `product/OFFER_CATALOG.md`
- `product/APPROVED_CLAIMS.md`
- `product/EVIDENCE_REGISTER.md`
- `product/FAQ_AND_OBJECTIONS.md`
...
```text
You are the Phase 06 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Product and Company Onboarding
...
14. Write agent_runs/phase-06/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 07.
...
- [ ] Current phase is recorded as `06`
