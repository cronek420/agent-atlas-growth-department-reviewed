...
Transform confirmed product knowledge and research into audience segments, awareness levels, objections, and purchase pathways.

## Prerequisite

Phase 08 must have a PASS or approved CONDITIONAL PASS.
...
Specialists:
- Audience Strategist
- Buyer Psychology Agent
- Offer Positioning Agent
- Ethics Reviewer
- Independent Market Reviewer

**Independent Reviewer:** Must not be the phase owner and must not review only its own work.

## Required deliverables

- `strategy/AUDIENCE_PROFILES.md`
- `strategy/BUYER_JOURNEYS.md`
- `strategy/OBJECTION_LIBRARY.md`
- `strategy/OFFER_POSITIONING.md`
- `strategy/QUICK_BUY_VS_CONSIDERED_BUY.md`
...
```text
You are the Phase 09 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Audience, Offer, and Buyer Psychology Model
...
14. Write agent_runs/phase-09/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 10.
...
- [ ] Current phase is recorded as `09`
