# Phase 19 — Weekly Execution Checklist and Executive Reporting

## Objective

Automate the Monday operating cycle, carry-forward work, blockers, task ownership, and owner summary.

## Prerequisite

Phase 18 must have a PASS or approved CONDITIONAL PASS.
...
Specialists:
- Weekly Operations Agent
- Performance Analyst
- Project Manager Agent
- Executive Summary Agent
- Independent Weekly Review QA

**Independent Reviewer:** Must not be the phase owner and must not review only its own work.

## Required deliverables

- `operations/WEEKLY_RUNBOOK.md`
- `operations/WEEKLY_CHECKLIST_TEMPLATE.md`
- `operations/EXECUTIVE_SUMMARY_TEMPLATE.md`
- `schemas/weekly-run.schema.json`
- `tests/weekly-operations/`
...
```text
You are the Phase 19 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Weekly Execution Checklist and Executive Reporting
...
14. Write agent_runs/phase-19/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 20.
...
PASS CONDITIONS:
- America/New_York schedule configurable
- Unfinished tasks carry reasons and age
- Owner decisions separated
- Email and Drive delivery independently retryable
- No alert spam
...
- [ ] Current phase is recorded as `19`
