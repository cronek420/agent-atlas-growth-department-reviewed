# Phase 22 — Budget Scaling and Paid Growth Guardrails

## Objective

Design—but do not initially activate—reinvestment rules, channel budgets, caps, approvals, and emergency stops.

## Prerequisite

Phase 21 must have a PASS or approved CONDITIONAL PASS.
...
- Risk Controller
- Attribution Analyst
- Independent Budget Reviewer

**Independent Reviewer:** Must not be the phase owner and must not review only its own work.

## Required deliverables

- `strategy/BUDGET_SCALING.md`
- `strategy/PAID_GROWTH_GATES.md`
- `schemas/budget-proposal.schema.json`
- `tests/budget-policy/`
...
```text
You are the Phase 22 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Budget Scaling and Paid Growth Guardrails
...
14. Write agent_runs/phase-22/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 23.
...
PASS CONDITIONS:
- No agent can authorize spend
- Gross revenue vs profit explicit
- Caps and stop-loss defined
- Attribution quality considered
...
- [ ] Current phase is recorded as `22`
