# Phase 15 — Approval Queue and Human Review Workflow

## Objective

Implement the Google Sheet approval queue, review packets, deterministic state transitions, and immutable approval history.

## Prerequisite

Phase 14 must have a PASS or approved CONDITIONAL PASS.
...
- UX Reviewer
- Independent Approval Auditor

**Independent Reviewer:** Must not be the phase owner and must not review only its own work.

## Required deliverables

- `architecture/APPROVAL_WORKFLOW.md`
- `schemas/approval.schema.json`
- `templates/APPROVAL_QUEUE.md`
- `tests/approval/`
- `runbooks/APPROVAL_RECOVERY.md`
...
```text
You are the Phase 15 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Approval Queue and Human Review Workflow
...
14. Write agent_runs/phase-15/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 16.
...
PASS CONDITIONS:
- No approval bypass
- Material edits reset approval
- History preserved
- Owner actions beginner-friendly
- Failure defaults to blocked
...
- [ ] Current phase is recorded as `15`
