...
No prior phase. Use the user's confirmed answers and mark unresolved decisions.
...
- Risk Analyst
- Product Strategist
- Independent Requirements Reviewer
...
```text
You are the Phase 00 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Decision Lock and Scope Control
...
14. Write agent_runs/phase-00/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 01.
...
PASS CONDITIONS:
- No code or external integration work
- Every material choice has a status and owner
- Contradictions are resolved or marked blocking
- Reviewer confirms no hidden assumptions
...
- [ ] Current phase is recorded as `00`
