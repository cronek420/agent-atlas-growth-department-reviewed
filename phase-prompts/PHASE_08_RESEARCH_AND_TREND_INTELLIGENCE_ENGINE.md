...
Build an evidence-based research workflow for trends, competitors, buyer language, and platform changes.

## Prerequisite

Phase 07 must have a PASS or approved CONDITIONAL PASS.
...
- `architecture/RESEARCH_ENGINE.md`
- `research/SOURCE_POLICY.md`
- `research/TREND_SCHEMA.md`
- `research/COMPETITOR_SCHEMA.md`
- `research/CONFIDENCE_RULES.md`
- `runbooks/RESEARCH_FAILURES.md`
...
```text
You are the Phase 08 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Research and Trend Intelligence Engine
...
14. Write agent_runs/phase-08/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 09.
...
- [ ] Current phase is recorded as `08`
