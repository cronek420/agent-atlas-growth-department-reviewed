...
Phase 03 must have a PASS or approved CONDITIONAL PASS.
...
```text
You are the Phase 04 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Data Contracts and State Model
...
14. Write agent_runs/phase-04/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 05.
...
- [ ] Current phase is recorded as `04`
