# Phase 14 — Copy Testing and Creative Experiment Design

## Objective

Create differentiated variants, heuristic scoring, test plans, evidence thresholds, and inconclusive-result handling.

## Prerequisite

Phase 13 must have a PASS or approved CONDITIONAL PASS.
...
- `experiments/COPY_TESTING_SOP.md`
- `experiments/SCORING_RUBRIC.md`
- `experiments/STOPPING_RULES.md`
- `schemas/copy-test.schema.json`
- `tests/copy-testing/`
...
```text
You are the Phase 14 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Copy Testing and Creative Experiment Design
...
14. Write agent_runs/phase-14/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 15.
...
PASS CONDITIONS:
- Heuristic scores not confused with sales
- Minimum evidence defined per channel
- Only one major variable changes
- Inconclusive is allowed
- Winner requires recorded evidence
...
- [ ] Current phase is recorded as `14`
