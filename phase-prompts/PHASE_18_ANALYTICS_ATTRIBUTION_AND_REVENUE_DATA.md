# Phase 18 — Analytics, Attribution, and Revenue Data

## Objective

Create a manual-first analytics model, then read-only adapters for Stripe, website, email, social, and CRM data.

## Prerequisite

Phase 17 must have a PASS or approved CONDITIONAL PASS.
...
- `analytics/ATTRIBUTION_POLICY.md`
- `analytics/MANUAL_ENTRY_TEMPLATE.md`
...
```text
You are the Phase 18 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Analytics, Attribution, and Revenue Data
...
14. Write agent_runs/phase-18/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 19.
...
PASS CONDITIONS:
- Metric definitions stable
- Missing data visible
- Attribution uncertainty labeled
- Revenue/profit separated
...
- [ ] Current phase is recorded as `18`
