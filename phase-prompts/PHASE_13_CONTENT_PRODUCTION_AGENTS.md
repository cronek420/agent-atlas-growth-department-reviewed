# Phase 13 — Content Production Agents

## Objective

Implement controlled producers for posts, images, carousels, blogs, newsletters, case studies, lead magnets, landing pages, product listings, emails, polls, tutorials, and demos.

## Prerequisite

Phase 12 must have a PASS or approved CONDITIONAL PASS.
...
```text
You are the Phase 13 Owner for the agent-atlas-growth-department project.
...
14. Write agent_runs/phase-13/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 14.
...
- Claims checked
- Parent/source asset tracked
- Media rights recorded
- Each producer has negative tests
...
- [ ] Current phase is recorded as `13`
