# Phase 11 — Social Presence Launch Kits

## Objective

Prepare platform-specific names, bios, graphics briefs, settings, launch posts, and human verification checklists.

## Prerequisite

Phase 10 must have a PASS or approved CONDITIONAL PASS.
...
- Independent Launch-Kit QA

**Independent Reviewer:** Must not be the phase owner and must not review only its own work.

## Required deliverables

- `social/ACCOUNT_REGISTER.md`
- `social/SETUP_CHECKLISTS/`
- `social/PROFILE_COPY/`
- `social/CREATIVE_BRIEFS/`
- `social/LAUNCH_POSTS/`
...
```text
You are the Phase 11 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Social Presence Launch Kits
...
14. Write agent_runs/phase-11/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 12.
...
PASS CONDITIONS:
- No captcha bypass
- No unsupported account creation
- Human checkpoints explicit
- Profiles match brand
- Links and claims validated
...
- [ ] Current phase is recorded as `11`
