...
Score candidate platforms and select a maintainable phased rollout based on audience fit, reach, intent, effort, risk, and measurement.

## Prerequisite

Phase 09 must have a PASS or approved CONDITIONAL PASS.
...
- Operations Capacity Reviewer
- API Feasibility Agent
- Independent Platform Reviewer

**Independent Reviewer:** Must not be the phase owner and must not review only its own work.

## Required deliverables

- `strategy/PLATFORM_SCORECARD.md`
- `strategy/ROLLOUT_WAVES.md`
- `strategy/CHANNEL_PLAYBOOKS.md`
- `strategy/PLATFORM_EXIT_RULES.md`
...
```text
You are the Phase 10 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Platform Strategy and Rollout Selection
...
14. Write agent_runs/phase-10/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 11.
...
- [ ] Current phase is recorded as `10`
