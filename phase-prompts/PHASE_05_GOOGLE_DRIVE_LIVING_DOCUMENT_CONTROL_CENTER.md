...
Design and safely create the dedicated Drive folder, managed-file registry, Docs/Sheets templates, and synchronization contract.

## Prerequisite

Phase 04 must have a PASS or approved CONDITIONAL PASS.
...
Specialists:
- Google Drive Architect
- Document Operations Specialist
- Sync Engineer
- Permission Reviewer
- Independent Drive QA

**Independent Reviewer:** Must not be the phase owner and must not review only its own work.

## Required deliverables

- `architecture/DRIVE_CONTROL_CENTER.md`
- `templates/DRIVE_FOLDER_MAP.md`
- `templates/SHEET_SCHEMAS.md`
- `templates/DOC_TEMPLATES.md`
- `schemas/managed-file.schema.json`
- `runbooks/DRIVE_SYNC_RECOVERY.md`
...
```text
You are the Phase 05 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Google Drive Living-Document Control Center
...
14. Write agent_runs/phase-05/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 06.
...
- [ ] Current phase is recorded as `05`
