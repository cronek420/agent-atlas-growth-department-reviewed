...
Phase 00 must have a PASS or approved CONDITIONAL PASS.
...
- Windows Setup Specialist
- Independent Setup Reviewer
...
```text
You are the Phase 01 Owner for the agent-atlas-growth-department project.

PHASE NAME:
Workspace, Repository, and Project Memory
...
14. Write agent_runs/phase-01/PHASE_GATE_REPORT.md.
15. Stop. Do not begin Phase 02.
...
- [ ] Current phase is recorded as `01`
